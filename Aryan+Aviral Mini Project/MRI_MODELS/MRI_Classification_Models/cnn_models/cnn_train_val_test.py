"""
Shared training, validation, and testing pipeline for CNN models.
"""
...
if __name__ == "__main__":
    # Example usage with 5-layer CNN
    from cnn_5layer import build_model, compile_model
    
    def model_builder(num_classes=4, learning_rate=1e-4, optimizer='adam', **kwargs):
