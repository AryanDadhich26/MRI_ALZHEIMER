"""
EfficientNetB3 pretrained on ImageNet for MRI brain image classification.
"""
...
def build_model(
    ...
    num_classes=4,
    # very small dropout decrease and slightly larger head
    dropout_rate=0.44,
    dense_units=1216,
    l2_reg=1e-5,
    ...
    Args:
        ...
        freeze_layers: Number of layers to freeze (default: 200)
